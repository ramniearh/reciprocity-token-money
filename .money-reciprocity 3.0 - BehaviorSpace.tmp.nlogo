...
<experiments>
  ...
  <experiment name="direct reciprocity verification" repetitions="100" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10000"/>
    <metric>cooperation-rate</metric>
  ...
  <experiment name="indirect reciprocity verification" repetitions="100" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10000"/>
    <metric>cooperation-rate</metric>
  ...
  <experiment name="money verification (copy)" repetitions="100" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10000"/>
    <metric>cooperation-rate</metric>
