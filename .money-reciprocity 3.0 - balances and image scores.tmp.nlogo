...
; DYNAMICS (a close approximation of Nowak 1998 - confirm added non-negative fitness and offspring procedure):
; Each turn represents one generation.
to go
  ; Reset reporters:
  ...
  ; Agents find a random match and act: they help if the partner's score (Nowak) or balance (Bigoni) is higher than their personal threshold:
  ...
  run-stats
  if stopper-500? and ticks > 500 [stop]
  if stopper-1000? and ticks > 1000 [stop]
  if stopper-convergence? and max k-payoffs-probs = 1 [stop]
  tick
end
...
to-report get-k-probs [ x ]
  report sum [fitness] of turtles with [k = x] / sum [fitness] of turtles
end


to run-stats
  set cooperation-rate cooperations-this-round / ( cooperations-this-round + defections-this-round )
  set Ncooperators count turtles with [k = -5]
  set Ncoop4 count turtles with [k = -4]
  set Ncoop3 count turtles with [k = -3]
  set Ncoop2 count turtles with [k = -2]
  set Ncoop1 count turtles with [k = -1]
  set Ndiscriminators count turtles with [k = 0]
  set Ndef1 count turtles with [k = 1]
  set Ndef2 count turtles with [k = 2]
  set Ndef3 count turtles with [k = 3]
  set Ndef4 count turtles with [k = 4]
  set Ndef5 count turtles with [k = 5]
  set Ndefectors count turtles with [k = 6]
...
"" ""
PENS
"-5 (cooperators)" 1.0 0 -13840069 true "" "plot sum [fitness] of turtles with [k = -5]"
"-4" 1.0 0 -1184463 true "" "plot sum [fitness] of turtles with [k = -4]"
"-3" 1.0 0 -987046 true "" "plot sum [fitness] of turtles with [k = -3]"
"-2" 1.0 0 -723837 true "" "plot sum [fitness] of turtles with [k = -2]"
"-1" 1.0 0 -526419 true "" "plot sum [fitness] of turtles with [k = -1]"
"0" 1.0 0 -13345367 true "" "plot sum [fitness] of turtles with [k = 0]"
"1" 1.0 0 -612749 true "" "plot sum [fitness] of turtles with [k = 1]"
"2" 1.0 0 -817084 true "" "plot sum [fitness] of turtles with [k = 2]"
"3" 1.0 0 -817084 true "" "plot sum [fitness] of turtles with [k = 3]"
"4" 1.0 0 -955883 true "" "plot sum [fitness] of turtles with [k = 4]"
"5" 1.0 0 -3844592 true "" "plot sum [fitness] of turtles with [k = 5]"
...
"" ""
PENS
"-5 (cooperators)" 1.0 0 -13840069 true "" "plot count turtles with [k = -5]"
"-4" 1.0 0 -1184463 true "" "plot count turtles with [k = -4]"
"-3" 1.0 0 -987046 true "" "plot count turtles with [k = -3]"
"-2" 1.0 0 -723837 true "" "plot count turtles with [k = -2]"
"-1" 1.0 0 -526419 true "" "plot count turtles with [k = -1]"
"0" 1.0 0 -13345367 true "" "plot count turtles with [k = 0]"
"1" 1.0 0 -408670 true "" "plot count turtles with [k = 1]"
"2" 1.0 0 -612749 true "" "plot count turtles with [k = 2]"
"3" 1.0 0 -817084 true "" "plot count turtles with [k = 3]"
"4" 1.0 0 -955883 true "" "plot count turtles with [k = 4]"
"5" 1.0 0 -6995700 true "" "plot count turtles with [k = 5]"
"6 (defectors)" 1.0 0 -12895429 true "" "plot count turtles with [k = 6]"
...
PENS
"default" 1.0 1 -16777216 true "" "histogram [k] of turtles"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "carefully [ plot cooperation-rate ][]"
...
518
average k
sum [k] of turtles / count turtles
1
1
11
...
442
174
Confirm: \"players leave offpsring in proportion to their fitness\" x k-prob strategy
10
0.0
1
...
<experiments>
  <experiment name="experiment" repetitions="100" runMetricsEveryStep="false">
    ...
    <metric>Ncoop3</metric>
    <metric>Ncoop2</metric>
    <metric>Ncoop1</metric>
    <metric>Ndiscriminators</metric>
    <metric>Ndef1</metric>
    <metric>Ndef2</metric>
    <metric>Ndef3</metric>
    <metric>Ndef4</metric>
    <metric>Ndef5</metric>
    <metric>Ndefectors</metric>
