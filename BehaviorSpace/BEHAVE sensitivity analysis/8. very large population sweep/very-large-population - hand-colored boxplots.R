...
# mean_money_prevalence_bc <- df_very_large_pop %>% 
...
df_very_large_pop %>% 
  ...
  facet_grid(initial_money~step) +
  ggtitle("Five strategies, large populations: Cooperation rates for different benefit/cost ratios. Selected time steps and liquidity values.")
...
summary_df_very_large_pop %>% 
  ...
  ggtitle("Five strategies, very large populations: evolution of surviving strategies by initial liquidity (pop=1500)")
