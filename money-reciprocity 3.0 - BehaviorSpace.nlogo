...
to define-initial-money
  ifelse initial-money < 1 [
    ifelse random-float 1 < initial-money [set balance 1][set balance 0]
  ]
  [
...
to go
  ...
  ask turtles [
    set fitness 0 ;testing CUMULATIVE FITNESS -- see evolution section below
  ...
  track-fitness ;this procedure also updates cumulative fitness
...
803
274
aggregate fitness of strategy on round
NIL
NIL
0.0
10.0
...
"" ""
PENS
"cooperators" 1.0 0 -13840069 true "" "plot sum [cumulative-fitness] of cooperators"
"defectors" 1.0 0 -7500403 true "" "plot sum [cumulative-fitness] of defectors"
...
<experiments>
  ...
  <experiment name="old ref experiment - sensitivity analysis full sweep 100x5 v2" repetitions="300" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10000"/>
    <metric>cooperation-rate</metric>
  ...
  <experiment name="reference - fine-tuned money 100x5 20k-steps 50" repetitions="50" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10000"/>
    <metric>cooperation-rate</metric>
  ...
  <experiment name="reference - fine-tuned without money 100x5 20k-steps 50 (copy)" repetitions="50" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10000"/>
    <metric>cooperation-rate</metric>
  ...
  <experiment name="CORE - fine-liquidity fine-tuned money 100x5 10k-steps 100r nodebt" repetitions="100" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10000"/>
    <metric>cooperation-rate</metric>
  ...
  <experiment name="CORE - fine-liquidity no-money 100x5 10k-steps 100r nodebt (copy)" repetitions="100" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10000"/>
    <metric>cooperation-rate</metric>
  ...
  <experiment name="CORE - fine-liquidity fine-tuned money 100x5 1k-steps 100r NOEVOL" repetitions="25" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>cooperation-rate</metric>
  ...
  <experiment name="CORE - money verification fine-fine 100x5 10k-steps 25r" repetitions="25" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10000"/>
    <metric>cooperation-rate</metric>
  ...
  <experiment name="FINAL-SM - POPULATION-LARGE - 300x5 10000s 100r (recovered)" repetitions="100" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10000"/>
    <metric>cooperation-rate</metric>
  ...
  <experiment name="FINAL-SM - HIGH-COOPERATION - 10000s 100r" repetitions="100" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10000"/>
    <metric>cooperation-rate</metric>
  ...
  <experiment name="FINAL-SM - NOEVOL - 250s 100r" repetitions="100" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="100"/>
    <metric>cooperation-rate</metric>
