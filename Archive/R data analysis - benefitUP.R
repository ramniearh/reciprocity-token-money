...
df_500_GC <- df_500 %>% 
  filter( sucker == "false" & cheater == "true" & grudger == "true" & token == "false" & rlm == "false" & token_share == 50 & grudger_memory == 5 & rlm_oversupply == "false") 
...
df_evol_all5 <- df %>% 
  filter( sucker == "false" & cheater == "true" & grudger == "true" & token == "false" & rlm == "false" ) %>%
