...
globals [ active-strategies total-welfare avg-welfare sucker-welfare cheater-welfare grudger-welfare token-welfare RLM-welfare reputation-welfare
  total-welfare-1000
  avg-welfare-1000
  sucker-welfare-1000
  ...
  sucker-perceived-payoffs
  cheater-perceived-payoffs
  grudger-perceived-payoffs
  reputation-perceived-payoffs
  token-perceived-payoffs
  RLM-perceived-payoffs
  total-payoffs
  sucker-payoff-share
  cheater-payoff-share
  grudger-payoff-share
  reputation-payoff-share
  token-payoff-share
  RLM-payoff-share
]
...
to setup
  ...
  if ( not sucker ) and ( not cheater ) and ( not grudger ) and ( not token ) and ( not RLM ) and ( not reputation ) [ error "No strategy selected. Execution stopped." stop ]
...
to set-me-up
  ...
  ifelse oversupply? [set my-balance 10] [set my-balance one-of [ 0 1 ]]; personal index, Bigoni 2020 (REVIEW OVERSUPPLY)
    shape-me
    size-me
    color-me
end
...
to go
  ...
  ask turtles [
    if ticks > 1 [ choose-strategy ] ;skip choice in first turn, where fitnesses are 0
    interact
    if my-strategy = "token" [ shape-me ]
    if my-strategy = "RLM" [ size-me ]
    if my-strategy = "reputation" [ patch-color-me ]
  ]

  ask turtles [ compute-perceived-payoffs  ]

  normalize-perceived-payoffs

  ;ask turtles [ set normalized-fitness fitness - avg-welfare ] ; normalize fitnesses:

  run-reporters

  ;if evolve? [ evolve-all ] ; NO EVOLUTION - probabilitic agent choice learning

  tick
  if stopper-100 [ if ticks = 100 [ stop ]]
  if ticks = 1000 [ report1000 ]
  if stopper-1000 [ if ticks = 1000 [ stop ]]
end
...
to choose-strategy ; check total normalized payoffs accumulated by all strategies until previous period. choose according to proportional probability.
  ;show my-strategy
  let x random-float 1
  ;show x
  ifelse x < sucker-payoff-share [ set my-strategy "sucker" ] [
    ifelse x < sucker-payoff-share + cheater-payoff-share [ set my-strategy "cheater" ] [
      ifelse x < sucker-payoff-share + cheater-payoff-share + grudger-payoff-share [ set my-strategy "grudger" ] [
        ifelse x < sucker-payoff-share + cheater-payoff-share + grudger-payoff-share + reputation-payoff-share [ set my-strategy "reputation" ] [
          ifelse x < sucker-payoff-share + cheater-payoff-share + grudger-payoff-share + reputation-payoff-share + token-payoff-share [ set my-strategy "token" ] [
            ifelse x < sucker-payoff-share + cheater-payoff-share + grudger-payoff-share + reputation-payoff-share + token-payoff-share + RLM-payoff-share [ set my-strategy "RLM" ] [
            show "none selected"
  ]]]]]]
  ;show my-strategy
end

to compute-perceived-payoffs
  if my-strategy = "sucker" [
    set sucker-perceived-payoffs sucker-perceived-payoffs + fitness - previous-fitness
  ]
  if my-strategy = "cheater" [
    set cheater-perceived-payoffs cheater-perceived-payoffs + fitness - previous-fitness
  ]
    if my-strategy = "grudger" [
    set grudger-perceived-payoffs grudger-perceived-payoffs + fitness - previous-fitness
  ]
  if my-strategy = "reputation" [
    set reputation-perceived-payoffs reputation-perceived-payoffs + fitness - previous-fitness
  ]
  if my-strategy = "token" [
    set token-perceived-payoffs token-perceived-payoffs + fitness - previous-fitness
  ]
  if my-strategy = "RLM" [
    set RLM-perceived-payoffs RLM-perceived-payoffs + fitness - previous-fitness
  ]
end

to normalize-perceived-payoffs
  set total-payoffs sucker-perceived-payoffs + cheater-perceived-payoffs + grudger-perceived-payoffs + reputation-perceived-payoffs + token-perceived-payoffs + RLM-perceived-payoffs
  set sucker-payoff-share sucker-perceived-payoffs / total-payoffs
  set cheater-payoff-share cheater-perceived-payoffs / total-payoffs
  set grudger-payoff-share grudger-perceived-payoffs / total-payoffs
  set reputation-payoff-share reputation-perceived-payoffs / total-payoffs
  set token-payoff-share token-perceived-payoffs / total-payoffs
  set RLM-payoff-share RLM-perceived-payoffs / total-payoffs
...
to run-reporters
  ...
  set RLM-population count turtles with [my-strategy = "RLM"]
...
"\"RLM\"" 1.0 0 -8630108 true "" "plot RLM-population"
...
745
440
shares of global perceived payoffs
NIL
NIL
0.0
10.0
...
"" ""
PENS
"default" 1.0 0 -13840069 true "" "plot sucker-payoff-share\n"
"pen-1" 1.0 0 -7500403 true "" "plot cheater-payoff-share"
"pen-2" 1.0 0 -955883 true "" "plot grudger-payoff-share"
"pen-4" 1.0 0 -1184463 true "" "plot reputation-payoff-share"
"pen-5" 1.0 0 -13345367 true "" "plot token-payoff-share"
"pen-56" 1.0 0 -8630108 true "" "plot RLM-payoff-share"
...
667
462
per-tick total payoffs
( sum [fitness] of turtles ) - ( sum [previous-fitness] of turtles )
1
1
11
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot ( sum [fitness] of turtles ) - ( sum [previous-fitness] of turtles )"
...
@#$#@#$#@
<experiments>
  <experiment name="global probabilistic choice - all 6 strategies - vary benefit" repetitions="100" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    ...
    <metric>count turtles with [my-strategy = "reputation"]</metric>
    <metric>count turtles with [my-strategy = "token"]</metric>
    <metric>count turtles with [my-strategy = "RLM"]</metric>
    <metric>sucker-perceived-payoffs</metric>
    <metric>cheater-perceived-payoffs</metric>
    <metric>grudger-perceived-payoffs</metric>
    <metric>reputation-perceived-payoffs</metric>
    <metric>token-perceived-payoffs</metric>
    <metric>RLM-perceived-payoffs</metric>
    ...
    <enumeratedValueSet variable="oversupply?">
      <value value="false"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="stopper-100">
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="token">
      <value value="true"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="leaky?">
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="sucker">
      <value value="true"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="KLRM">
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="token-share">
      <value value="50"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="min-K-score">
      <value value="-1"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="stopper-500">
      <value value="false"/>
    </enumeratedValueSet>
